...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/docs/documentation/compute/quickstart">
    Provision your first instance and run a GPU workload
  </Card>

  <Card title="Pricing" icon="credit-card" href="/docs/documentation/compute/pricing">
