...
<Card title="Synchronous Inference" href="/docs/documentation/model-apis/inference/synchronous">
...
<Card title="Asynchronous Inference" href="/docs/documentation/model-apis/inference/queue">
...
<CardGroup cols={2}>
  <Card title="Building Streaming Endpoints" href="/docs/documentation/development/streaming">
    How to implement SSE streaming in your fal.App
  </Card>

  <Card title="Streaming Inference" href="/docs/documentation/model-apis/inference/streaming">
...
<CardGroup cols={2}>
  <Card title="Building Realtime Endpoints" href="/docs/documentation/development/realtime">
    How to implement WebSocket endpoints in your fal.App
  </Card>

  <Card title="Real-Time Inference" href="/docs/documentation/model-apis/inference/real-time">
...
<Card title="Webhooks API" href="/docs/documentation/model-apis/inference/webhooks">
...
See [Platform Headers](/docs/documentation/model-apis/common-parameters) for all available headers, and [Retries](/docs/documentation/serverless/reliability/retries) for retry control. Each inference method page also documents its available SDK parameters.

## Next Steps

<CardGroup cols={2}>
  <Card title="Inference Documentation" href="/docs/documentation/model-apis/inference">
    Full details on all calling methods, parameters, status polling, and the request handle
  </Card>

  <Card title="Async Inference (Queue)" href="/docs/documentation/model-apis/inference/queue">
    Submit, status, result, cancel, webhooks, and streaming status updates
  </Card>

  <Card title="Client Setup" href="/docs/documentation/model-apis/inference/client-setup">
    Install and configure the fal client SDK
  </Card>

  <Card title="Handle Inputs & Outputs" href="/docs/documentation/development/handle-inputs-and-outputs">
