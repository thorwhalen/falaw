...
* remembers `url -> (content_hash, bytes_size, validators)` in a small
  ...
  - **anything else** — an arbitrary caller-supplied `https://…/reference.png`
    reached through [`falaw.cache.materialize_asset()`](falaw.cache.md#falaw.cache.materialize_asset), or a `file://` clip
...
[`content_ref_for_url()`](#falaw.content.content_ref_for_url), [`falaw.materialize_asset()`](falaw.md#falaw.materialize_asset),
[`falaw.execute_plan()`](falaw.md#falaw.execute_plan) and [`falaw.execute_plan_isolated()`](falaw.md#falaw.execute_plan_isolated) in one
...
than raising. [`falaw.testing`](falaw.testing.md#module-falaw.testing) ships the fake so no consumer has to write
one.
...
* **Raises:**
  [**FalAssetFetchError**](falaw.md#falaw.FalAssetFetchError) – the bytes could not be retrieved, or the response
...
[`falaw.materialize_asset()`](falaw.md#falaw.materialize_asset), [`falaw.execute_plan()`](falaw.md#falaw.execute_plan) and
[`falaw.execute_plan_isolated()`](falaw.md#falaw.execute_plan_isolated) — honours an override installed after
they were imported.
...
[`falaw.cache.materialize_asset()`](falaw.cache.md#falaw.cache.materialize_asset).
