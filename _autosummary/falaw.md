...
* **Return type:**
  [`AreaUsage`](falaw.prune.md#falaw.prune.AreaUsage)
...
(falaw#15) — see [`falaw.backends`](falaw.backends.md#module-falaw.backends). Defaults to
[`falaw.canonical.DFLT_BACKEND`](falaw.canonical.md#falaw.canonical.DFLT_BACKEND) (`"fal"`), the only backend until a
...
cached keeps its exact pre-#15 digest — see [`falaw.canonical`](falaw.canonical.md#module-falaw.canonical).
...
#### cost_basis *: [CostBasis](falaw.plan.md#falaw.plan.CostBasis) | [None](https://docs.python.org/3/builtins/constants.html#None)*
...
[`falaw.reprice.DFLT_PRICERS`](falaw.reprice.md#falaw.reprice.DFLT_PRICERS). `"model_catalogue"` for a record
...
zip against [`outcomes`](falaw.outcomes.md#module-falaw.outcomes) and stay aligned. Zipping against a
...
#### *property* blocked *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[CallOutcome](falaw.outcomes.md#falaw.outcomes.CallOutcome), ...]*
...
#### *property* failed *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[CallOutcome](falaw.outcomes.md#falaw.outcomes.CallOutcome), ...]*
...
[`outcomes`](falaw.outcomes.md#module-falaw.outcomes) for anything positional.

#### *property* succeeded *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[CallOutcome](falaw.outcomes.md#falaw.outcomes.CallOutcome), ...]*
...
Bases: [`FalError`](falaw.errors.md#falaw.errors.FalError)

The bytes behind a fal-served asset URL could not be retrieved.

Raised by [`falaw.content`](falaw.content.md#module-falaw.content) when content-addressing an artifact fails —
...
Raised by [`falaw.canonical`](falaw.canonical.md#module-falaw.canonical) when a value reaches a key-composition
...
* **Return type:**
  [`Plan`](falaw.plan.md#falaw.plan.Plan)
...
Read [`plan`](falaw.plan.md#module-falaw.plan) for the re-quoted plan (it is an ordinary
...
#### calls *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[CallRepricing](falaw.reprice.md#falaw.reprice.CallRepricing), ...]*

One entry per call of the input plan, in order.

#### *property* changed *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[CallRepricing](falaw.reprice.md#falaw.reprice.CallRepricing), ...]*
...
#### *property* unpriced *: [tuple](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[CallRepricing](falaw.reprice.md#falaw.reprice.CallRepricing), ...]*
...
* **Return type:**
  [`Scene`](falaw.scene.md#falaw.scene.Scene)
...
* **Return type:**
  [`Beat`](falaw.scene.md#falaw.scene.Beat)
...
* **Parameters:**
  ...
  * **backend** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – which execution backend produced `raw` (falaw#15). Joins
    ...
    [`falaw.canonical.cache_key_payload()`](falaw.canonical.md#falaw.canonical.cache_key_payload); recorded in the
...
[`falaw.prune`](falaw.prune.md#module-falaw.prune).
...
* **Return type:**
  [`CacheUsage`](falaw.prune.md#falaw.prune.CacheUsage)
...
* **Parameters:**
  ...
  * **on_event** – Per-call subscriber for [`falaw.events.ProgressEvent`](falaw.events.md#falaw.events.ProgressEvent).
  ...
  * **backend** ([`str`](https://docs.python.org/3/builtins/stdtypes.html#str)) – which execution backend serves this call (falaw#15) —
    resolved via [`falaw.backends`](falaw.backends.md#module-falaw.backends). Also joins the cache key
...
* **Return type:**
  [`CallPlan`](falaw.plan.md#falaw.plan.CallPlan)
...
* **Return type:**
  [`ContentRef`](falaw.content.md#falaw.content.ContentRef)
...
[`falaw.plan.execute()`](falaw.plan.md#falaw.plan.execute) calls it.
...
* **Return type:**
  [`CostRollup`](falaw.cost.md#falaw.cost.CostRollup)
...
[`falaw.errors`](falaw.errors.md#module-falaw.errors) — is what a caller classifies on, so it is never
...
* **Parameters:**
  ...
  * **content_store** – Injected `lacing.ArtifactStore` that media bytes
    ...
    [`falaw.content.default_content_store()`](falaw.content.md#falaw.content.default_content_store) (a directory store
  ...
  * **asset_fetcher** – Injected byte source (`url -> Iterable[bytes]`) used to
    ...
    [`falaw.content.default_url_fetcher()`](falaw.content.md#falaw.content.default_url_fetcher). This is the per-call
    transport seam. A **hermetic test suite** usually wants the
    process-wide one instead — [`falaw.testing.fake_assets()`](falaw.testing.md#falaw.testing.fake_assets), built
    on [`falaw.content.using_url_fetcher()`](falaw.content.md#falaw.content.using_url_fetcher) — because a suite
...
* **Return type:**
  [`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`LlmRate`](falaw.llm_rates.md#falaw.llm_rates.LlmRate)]
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`LlmRate`](falaw.llm_rates.md#falaw.llm_rates.LlmRate)]
...
* **Return type:**
  [`tuple`](https://docs.python.org/3/builtins/stdtypes.html#tuple)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`LlmReceipt`](falaw.operations.llm.md#falaw.operations.llm.LlmReceipt)]
...
[`falaw.llm_rates.CUSTOM_LLM_RATES_TABLE`](falaw.llm_rates.md#falaw.llm_rates.CUSTOM_LLM_RATES_TABLE). [`reprice_plan()`](#falaw.reprice_plan) then
...
* **Raises:**
  [**FalNonCanonicalArgument**](falaw.errors.md#falaw.errors.FalNonCanonicalArgument) – an argument cannot be hashed
...
[`falaw.content.is_immutable_url()`](falaw.content.md#falaw.content.is_immutable_url) — because reaching it requires
...
URL goes to circle 2, where [`falaw.content.content_ref_for_url()`](falaw.content.md#falaw.content.content_ref_for_url)
...
* **Raises:**
  [**FalAssetFetchError**](falaw.errors.md#falaw.errors.FalAssetFetchError) – the bytes could not be retrieved.
      Unlike a generated-media artifact (which degrades to URL-only —
      see [`falaw.plan.execute()`](falaw.plan.md#falaw.plan.execute)), there is nothing to degrade to
...
* **Return type:**
  [`ModelRecord`](falaw.base.md#falaw.base.ModelRecord)
...
([`falaw.canonical.plan_identity_payload()`](falaw.canonical.md#falaw.canonical.plan_identity_payload)) — matching
...
call-for-call. Both projections live side by side in [`falaw.canonical`](falaw.canonical.md#module-falaw.canonical)
with one shared byte-form ([`falaw.canonical.canonical_blob()`](falaw.canonical.md#falaw.canonical.canonical_blob) — sorted
keys, **no** `default=str` fallback, no NaN), so an argument the form
cannot represent faithfully raises
[`falaw.errors.FalNonCanonicalArgument`](falaw.errors.md#falaw.errors.FalNonCanonicalArgument) instead of colliding, and a
...
- a model the rate table does not price, or a token quote that cannot be
  ...
  [`falaw.plan.Plan.has_unknown_costs`](falaw.plan.md#falaw.plan.Plan.has_unknown_costs) and forces approval. It is
...
* **Returns:**
  with `area="assets"`.
* **Return type:**
  [`PruneReport`](falaw.prune.md#falaw.prune.PruneReport)
* **Raises:**
...
* **Parameters:**
  ...
  * **dry_run** ([`bool`](https://docs.python.org/3/builtins/functions.html#bool)) – report without deleting. Default, deliberately.
  * **store** – injected `lacing.ArtifactStore`; defaults to
    [`falaw.content.default_content_store()`](falaw.content.md#falaw.content.default_content_store), whose deletes remove
...
* **Parameters:**
  ...
  * **pricers** ([`Mapping`](https://docs.python.org/3/library/typing.html#typing.Mapping)[[`str`](https://docs.python.org/3/builtins/stdtypes.html#str), [`Pricer`](falaw.reprice.md#falaw.reprice.Pricer)]) – Pricing rules by [`falaw.CostBasis.pricer`](#falaw.CostBasis.pricer) name. The seam
    for a caller who has reconciled real numbers against their own
    invoice — see [`Pricer`](#falaw.Pricer).
* **Return type:**
  [`RepricedPlan`](falaw.reprice.md#falaw.reprice.RepricedPlan)
...
* **Return type:**
  [`Callable`](https://docs.python.org/3/library/typing.html#typing.Callable)[[[`ProgressEvent`](falaw.events.md#falaw.events.ProgressEvent)], [`None`](https://docs.python.org/3/builtins/constants.html#None)]
...
For a ready-made fake with pinned bytes and 404s, see [`falaw.testing`](falaw.testing.md#module-falaw.testing).
...
| [`journal`](falaw.journal.md#module-falaw.journal)                     | Agent journal: append-only log of notes, issues and improvements.                                                     |
|---------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| [`account`](falaw.account.md#module-falaw.account)                     | Account health probe.                                                                                                 |
| [`backends`](falaw.backends.md#module-falaw.backends)                   | Execution backend registry — where `CallPlan.backend` dispatches (falaw#15).                                          |
| [`base`](falaw.base.md#module-falaw.base)                           | Core types: ToolSpec and ModelRecord.                                                                                 |
| [`bridges`](falaw.bridges.md#module-falaw.bridges)                     | Bridges: derive auxiliary surfaces (skill, MCP, HTTP service) from the tool registry.                                 |
| [`cache`](falaw.cache.md#module-falaw.cache)                         | Content-addressed cache for fal calls.                                                                                |
| [`canonical`](falaw.canonical.md#module-falaw.canonical)                 | One canonical byte-form for everything falaw hashes (falaw#17).                                                       |
| [`content`](falaw.content.md#module-falaw.content)                     | Content addressing for fal-produced media — identify a file by *what it is*.                                          |
| [`core`](falaw.core.md#module-falaw.core)                           | Wrapper over `fal_client.subscribe` with progress events and auto-journaling.                                         |
| [`corpus`](falaw.corpus.md#module-falaw.corpus)                       | Extract model records from `misc/docs/llms-full.txt`.                                                                 |
| [`cost`](falaw.cost.md#module-falaw.cost)                           | Cost estimation: ModelRecord.cost_estimate + Scene rollups.                                                           |
| [`degrade`](falaw.degrade.md#module-falaw.degrade)                     | Where falaw sends "I carried on, but you should know" — one collection point.                                         |
| [`errors`](falaw.errors.md#module-falaw.errors)                       | Typed exceptions for falaw operations.                                                                                |
| [`events`](falaw.events.md#module-falaw.events)                       | Structured progress events for fal calls.                                                                             |
| [`llm_rates`](falaw.llm_rates.md#module-falaw.llm_rates)                 | Per-routed-model LLM rates: the data behind a *ceiling* quote (falaw#50, option A).                                   |
| [`llm_rates_refresh`](falaw.llm_rates_refresh.md#module-falaw.llm_rates_refresh) | Refresh proposals for the LLM rate table, never a silent overwrite (falaw#56).                                        |
| [`local`](falaw.local.md#module-falaw.local)                         | Local utilities: ffmpeg + PIL glue for stitching fal outputs.                                                         |
| [`operations`](falaw.operations.md#module-falaw.operations)               | Task-level verbs: stable, agent-friendly entry points.                                                                |
| [`outcomes`](falaw.outcomes.md#module-falaw.outcomes)                   | Per-call outcomes of running a [`falaw.Plan`](#falaw.Plan) — the partial-result type. |
| [`plan`](falaw.plan.md#module-falaw.plan)                           | Plan / Execute primitives — separate planning (data) from execution (effects).                                        |
| [`pricing`](falaw.pricing.md#module-falaw.pricing)                     | Read fal's pricing API into `models.json` cost estimates (falaw#18).                                                  |
| [`prune`](falaw.prune.md#module-falaw.prune)                         | Capacity management for the falaw cache: see what is on disk, and reclaim it.                                         |
| [`refresh`](falaw.refresh.md#module-falaw.refresh)                     | Refresh fal.ai docs locally with conditional GETs.                                                                    |
| [`registry`](falaw.registry.md#module-falaw.registry)                   | Tool and model registries.                                                                                            |
| [`reprice`](falaw.reprice.md#module-falaw.reprice)                     | Re-quote a persisted [`falaw.Plan`](#falaw.Plan) at today's rates (falaw#60).         |
| [`results`](falaw.results.md#module-falaw.results)                     | Result wrapper: parse fal responses into typed assets, lazy download.                                                 |
| [`scene`](falaw.scene.md#module-falaw.scene)                         | Scene IR: the editable structure that survives all the way to the pixels.                                             |
| [`schema_export`](falaw.schema_export.md#module-falaw.schema_export)         | Export the Python SSOT as committed JSON for the TypeScript twin (`ts/`).                                             |
| [`session`](falaw.session.md#module-falaw.session)                     | Session: optional stateful controller over a sequence of falaw operations.                                            |
| [`testing`](falaw.testing.md#module-falaw.testing)                     | Make a suite that uses falaw genuinely offline — the fake asset transport.                                            |
