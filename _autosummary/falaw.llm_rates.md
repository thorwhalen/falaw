...
| [`LLM_RATES_TABLE`](#falaw.llm_rates.LLM_RATES_TABLE)                  | Identity a [`falaw.CostBasis`](falaw.md#falaw.CostBasis) records for an LLM-priced call. |
...
| [`llm_rates_table_version`](#falaw.llm_rates.llm_rates_table_version)()                        | The rate table's version — see [`falaw.base.data_table_version()`](falaw.base.md#falaw.base.data_table_version). |
...
price drop. [`falaw.reprice_plan()`](falaw.md#falaw.reprice_plan) therefore refuses a basis whose `table`
does not match the pricer’s, reporting it as unknown; a caller who wants their
own numbers re-quoted passes a [`falaw.Pricer`](falaw.md#falaw.Pricer) that names this table.
...
Identity a [`falaw.CostBasis`](falaw.md#falaw.CostBasis) records for an LLM-priced call.
...
The rate table’s version — see [`falaw.base.data_table_version()`](falaw.base.md#falaw.base.data_table_version).
