...
- `estimate_scene_cost(scene, *, ...)()` — walk every Shot + Beat in a
  [`falaw.Scene`](falaw.md#falaw.Scene) and sum the per-call costs that
  [`falaw.render_scene()`](falaw.md#falaw.render_scene) would incur. Returns a structured rollup
