...
| [`MODEL_CATALOGUE_TABLE`](#falaw.registry.MODEL_CATALOGUE_TABLE)   | Identity a [`falaw.CostBasis`](falaw.md#falaw.CostBasis) records for a catalogue-priced call.   |
|--------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
...
| [`models_table_version`](#falaw.registry.models_table_version)()                   | The catalogue's version — see [`falaw.base.data_table_version()`](falaw.base.md#falaw.base.data_table_version). |
...
Identity a [`falaw.CostBasis`](falaw.md#falaw.CostBasis) records for a catalogue-priced call.
...
The catalogue’s version — see [`falaw.base.data_table_version()`](falaw.base.md#falaw.base.data_table_version).
